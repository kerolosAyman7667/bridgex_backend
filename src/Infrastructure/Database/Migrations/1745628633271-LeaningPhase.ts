...
export class LeaningPhase1745628633271 implements MigrationInterface {
    name = 'LeaningPhase1745628633271'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`user_progress\` (\`UserId\` varchar(32) NOT NULL, \`VideoId\` varchar(32) NOT NULL, \`IsCompleted\` tinyint NOT NULL DEFAULT 0, \`WatchDuration\` decimal(12,2) NULL, \`Id\` varchar(32) NOT NULL, \`CreatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`UpdatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`Id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`learning_phase_videos\` (\`Name\` varchar(50) NOT NULL, \`SectionId\` varchar(32) NOT NULL, \`File\` varchar(500) NOT NULL, \`Desc\` varchar(325) NULL, \`Duration\` decimal(12,2) NULL, \`Id\` varchar(32) NOT NULL, \`CreatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`UpdatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`Id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`learning_phase_resources\` (\`Name\` varchar(50) NOT NULL, \`SectionId\` varchar(32) NOT NULL, \`File\` varchar(500) NOT NULL, \`AIAssetId\` varchar(24) NULL, \`Id\` varchar(32) NOT NULL, \`CreatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`UpdatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`Id\`)) ENGINE=InnoDB`);
